...
type TGUpload struct {
	EncryptionKey string        `validate:"required" koanf:"encryption-key" default:"" description:"Encryption key for uploads"`
...
func (cl *ConfigLoader) RegisterFlags(flags *pflag.FlagSet) {
	...
	cl.registerStruct(flags, "", reflect.TypeFor[ServerCmdConfig]())
}
